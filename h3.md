...
Käytin tehtävässä omaa Windows 10 Pro työasemaani ja Oracle VM VirtualBoxia, jossa Xubuntu 18.04.1 64-bit, Kali Linux Xfce 64 Bit ja Ubuntu Server 16.04.5 LTS. Koneen prossu: Intel Core i5 4690K @ 3.50GHz.
...
Olin jo aikaisemmin tunnilla laittanut /srv/salt -kansion gittiin, joten kloonasin tämän salt repon sieltä Xubuntu VM:ään.
