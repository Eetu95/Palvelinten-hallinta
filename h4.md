...
Jatkoin tehtävää Pasilan Haaga-Helian servulassa HP ProDesk 600 G3 MT Desktop - Linux Xubuntu 18.04.1 64-bit (livetikku) koneella. Tein tehtävän samaan kohtaan kuin kotona (Vagrant ja VBox asennus jne.) Päätin tällä kertaa valita Vagrant kuvaksi
