...
php7.0.conf -tiedosto päivittyi oikeille asetuksille. php7.0.conf -tiedosto päivittyi. <ifModule... oli kommentoitu ulos kun kävin katsomassa tilan ajon jälkeen Ubuntu Serverillä.
